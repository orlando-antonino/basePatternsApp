...
public class ActionBarHelperBase extends ActionBarHelper {
	...
	private void setupActionBar() {
		...
		if(goBack){
			SimpleMenuItem back = new SimpleMenuItem(
					tempMenu, android.R.id.button1, 0, mActivity.getString(R.string.app_name));
			back.setIcon(R.drawable.navigation_previous_item);
			addBackItemCompatFromMenuItem(back);
		}
	...
	private View addActionItemCompatFromMenuItem(final MenuItem item) {
		...
		int withIconHome = (int) mActivity.getResources().getDimension(
				itemId == android.R.id.home
				? R.dimen.actionbar_compat_button_home_width
						: R.dimen.actionbar_compat_button_width);

//		withIconHome = goBack? withIconHome/2:withIconHome;
		...
		if(goBack){
			...
			paramLayout.setMargins((int) mActivity.getResources().getDimension(R.dimen.actionbar_compat_home_back_margin), 0, 0, 0);
		}
		
		actionButton.setLayoutParams(paramLayout);
...
//        buttonParams.gravity = Gravity.LEFT;
	 ...
	 * @return
	 */
	private View addBackItemCompatFromMenuItem(final MenuItem item) {
		final int itemId = item.getItemId();
		...
		actionButton.setLayoutParams(new ViewGroup.LayoutParams(
				(int) mActivity.getResources().getDimension(
						R.dimen.actionbar_compat_button_back_width),
						ViewGroup.LayoutParams.FILL_PARENT));
		if (itemId == R.id.menu_refresh) {
			actionButton.setId(R.id.actionbar_compat_item_refresh);
		}
	...
	@Override
	public void setBackHomeButtonActionItem(boolean goBack) {
		this.goBack = goBack; 
		setupActionBar();
	}
}
